...
parser.add_argument('--csv_input', type=str, help='csv path')
parser.add_argument('--output_path', type=str, help='the output path')
parser.add_argument('--dir', type=str, help='the image directory')
...
def create_tf_example(group, path):
    with tf.io.gfile.GFile(os.path.join(path, str(group.filename)), 'rb') as fid:
